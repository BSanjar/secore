...
public partial class Invoice
{
    ...
    /// <summary>
    /// (ТЫЙЫНЫ)фиксированная сумма платежа, если не указан или 0 то сумма для платежа любая сумма
    /// </summary>
    ...
    /// <summary>
    /// reuse_active - многоразовый , regenerate_per_period - с периодичностью (может быть одноразовым)
    /// </summary>
    ...
    public virtual InvoiceQr? InvoiceQr { get; set; }
